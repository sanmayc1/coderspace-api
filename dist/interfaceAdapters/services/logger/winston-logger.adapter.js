...
const winston_1 = require("../../../frameworks/logger/winston");
let WinstonLoggerAdapter = class WinstonLoggerAdapter {
    info(message, meta) {
        winston_1.logger.info(message, meta);
    }
    warn(message, meta) {
        winston_1.logger.warn(message, meta);
    }
    error(message, meta) {
        winston_1.logger.error(message, meta);
    }
    debug(message, meta) {
        winston_1.logger.debug(message, meta);
    }
};
