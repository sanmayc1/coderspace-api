...
let GetCompanyUsecase = class GetCompanyUsecase {
    _accountRepository;
    _companyRepository;
    constructor(_accountRepository, _companyRepository) {
    ...
    async execute(accountId) {
        ...
        if (!company) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.COMPANY_NOT_FOUND);
        }
        const response = mappers_1.getCompanyUsecaseMapper.toResponse(account, company);
        return response;
    }
};
...
exports.GetCompanyUsecase = GetCompanyUsecase = __decorate([
    ...
    __param(1, (0, tsyringe_1.inject)('ICompanyRepository')),
    __metadata("design:paramtypes", [Object, Object])
], GetCompanyUsecase);
//# sourceMappingURL=get.company.usecase.js.map