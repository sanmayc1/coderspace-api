...
let CreateSkillUsecase = class CreateSkillUsecase {
    ...
    async execute(title) {
        ...
        if (skillExist) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.SKILL_EXIST);
        }
...
//# sourceMappingURL=create-skill.usecase.js.map