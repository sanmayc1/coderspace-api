...
exports.GetProblemUsecase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom-error");
const constant_1 = require("../../../shared/constant");
const mappers_1 = require("../../dtos/mappers/mappers");
let GetProblemUsecase = class GetProblemUsecase {
    _problemRepository;
    ...
    async execute(id) {
        ...
        return mappers_1.getProblemUsecaseMapper.toResponse(exists);
    }
};
exports.GetProblemUsecase = GetProblemUsecase;
exports.GetProblemUsecase = GetProblemUsecase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IProblemRepository')),
    __metadata("design:paramtypes", [Object])
], GetProblemUsecase);
//# sourceMappingURL=get-problem.usecase.js.map