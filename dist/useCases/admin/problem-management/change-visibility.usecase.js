...
exports.ChangeVisibilityUsecase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom-error");
const constant_1 = require("../../../shared/constant");
let ChangeVisibilityUsecase = class ChangeVisibilityUsecase {
    _problemRepository;
    _testcaseRepository;
    ...
    async execute(id) {
        ...
        if (exits.view === 'private' && exits.addedLanguagesId.length === 0) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.NO_LANGUAGE_ADDED);
        }
        const testcases = await this._testcaseRepository.getTestcasesByProblemId(id);
        if (testcases.length === 0) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.NO_TESTCASE_ADDED);
        }
...
exports.ChangeVisibilityUsecase = ChangeVisibilityUsecase;
exports.ChangeVisibilityUsecase = ChangeVisibilityUsecase = __decorate([
...
//# sourceMappingURL=change-visibility.usecase.js.map