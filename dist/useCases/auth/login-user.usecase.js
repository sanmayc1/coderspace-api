...
let LoginUserUsecase = class LoginUserUsecase {
    ...
    _uniqueIdService;
    _accountRepository;
    constructor(_userRepository, _bcrypt, _jwtService, _uniqueIdService, _accountRepository) {
    ...
    async execute(data) {
        ...
        if (account.isBlocked) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.FORBIDDEN, constant_1.ERROR_MESSAGES.ACCOUNT_BLOCKED, 'password');
        }
        ...
        const response = register_usecase_mapper_1.LoginUsecaseMapper.toResponse(account, user);
        return {
            accessToken,
            refreshToken,
            deviceId,
...
exports.LoginUserUsecase = LoginUserUsecase = __decorate([
    ...
    __param(3, (0, tsyringe_1.inject)('IUniqueIdService')),
    __param(4, (0, tsyringe_1.inject)('IAccountRepository')),
