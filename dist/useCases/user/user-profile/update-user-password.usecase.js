...
let UpdateUserPasswordUsecase = class UpdateUserPasswordUsecase {
    ...
    async execute(data) {
        ...
        if (!isPasswordValid) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.VALIDATION_ERROR, 'currentPassword');
        }
        if (data.newPassword === data.currentPassword) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.OLD_PASSWORD_AND_NEW_PASSWORD_SAME);
        }
...
exports.UpdateUserPasswordUsecase = UpdateUserPasswordUsecase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IAccountRepository')),
    __param(1, (0, tsyringe_1.inject)('IBcrypt')),
    __metadata("design:paramtypes", [Object, Object])
], UpdateUserPasswordUsecase);
//# sourceMappingURL=update-user-password.usecase.js.map