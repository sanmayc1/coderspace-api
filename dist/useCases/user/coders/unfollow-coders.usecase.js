...
exports.UnfollowCodersUsecase = void 0;
const tsyringe_1 = require("tsyringe");
const constant_1 = require("../../../shared/constant");
const custom_error_1 = require("../../../domain/utils/custom-error");
let UnfollowCodersUsecase = class UnfollowCodersUsecase {
    _userRepository;
    _followerRepository;
    ...
    async execute(accountId, followingId) {
        ...
        if (!isFollowing) {
            throw new custom_error_1.CustomError(constant_1.HTTP_STATUS.BAD_REQUEST, constant_1.ERROR_MESSAGES.USER_NOT_FOLLOWING);
        }
        await this._followerRepository.deleteById(isFollowing._id);
    }
};
exports.UnfollowCodersUsecase = UnfollowCodersUsecase;
exports.UnfollowCodersUsecase = UnfollowCodersUsecase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IUserRepository')),
    __param(1, (0, tsyringe_1.inject)('IFollowerRepository')),
    __metadata("design:paramtypes", [Object, Object])
], UnfollowCodersUsecase);
//# sourceMappingURL=unfollow-coders.usecase.js.map