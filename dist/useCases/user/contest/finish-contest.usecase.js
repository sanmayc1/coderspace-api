...
exports.FinishContestUsecase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom-error");
const constant_1 = require("../../../shared/constant");
let FinishContestUsecase = class FinishContestUsecase {
    _contestRepository;
    _userRepository;
    ...
    async execute(contestId, accountId) {
        ...
        await this._contestAttemptRepository.updateById(contestAttempt._id, {
            endDateAndTime: new Date(),
        });
    }
};
exports.FinishContestUsecase = FinishContestUsecase;
exports.FinishContestUsecase = FinishContestUsecase = __decorate([
...
//# sourceMappingURL=finish-contest.usecase.js.map