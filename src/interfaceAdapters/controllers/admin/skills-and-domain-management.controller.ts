...
import { ICreateDomainUsecase } from '../../../useCases/Interfaces/admin/skills-and-domain-management/create-domain.usecase.interface';
import {
  commonResponse,
  CustomError,
  ERROR_MESSAGES,
...
export class SkillAndDomainManagementController {
  ...
  async createSkill(req: Request, res: Response) {
    ...
    res.status(HTTP_STATUS.OK).json(commonResponse(true, SUCCESS_MESSAGES.SKILL_CREATED));
  }
