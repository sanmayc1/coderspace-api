...
import { IGetAllSkillsUsecase } from "../../../useCases/Interfaces/admin/skills-and-domain-management/get-all-skills.usecase.interface.js";
...
export class SkillAndDomainManagementController {
  constructor(
    @inject("ICreateDomainUsecase") private _createDomainUsecase: ICreateDomainUsecase,
    @inject("IGetAllDomains") private _getAllDomainsUsecase: IGetAllDomainsUsecase,
    @inject("IDeleteDomainUsecase") private _deleteDomainUsecase: IDeleteDomainUsecase,
    @inject("IGetAllSkillsUsecase") private _getAllSkillsUsecase:IGetAllSkillsUsecase,
    @inject("IDeleteSkillUsecase") private _deleteSkillUsecase:IDeleteSkillUsecase,
    @inject("ICreateSkillUsecase") private _createSkillUsecase:ICreateSkillUsecase
  ) {}
  ...
  async deleteDomain(req: Request, res: Response) {
    ...
    res.status(HTTP_STATUS.OK).json(commonResponse(true,SUCCESS_MESSAGES.DOMAIN_DELETED))
  }
  ...
  async deleteSkill(req: Request, res: Response) {
    ...
    res.status(HTTP_STATUS.OK).json(commonResponse(true,SUCCESS_MESSAGES.SKILL_DELETED))
  }
}
