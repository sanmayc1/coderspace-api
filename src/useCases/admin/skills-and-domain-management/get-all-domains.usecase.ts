...
import { IGetAllDomainsUsecase } from "../../Interfaces/admin/skills-and-domain-management/get-all-domains.interface.usecase.js";
import { IDomainRepository } from "../../../domain/repositoryInterfaces/domain-respository.interface.js";
import { getAllDomainsUsecaseMapper } from "../../dtos/mappers/mappers.js";
