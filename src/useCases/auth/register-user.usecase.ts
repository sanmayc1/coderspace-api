...
import { IRegisterUserUsecase } from '../Interfaces/auth/register-user-usecase.interface';
...
import { RegisterUserRequestDto } from '../dtos/auth.dto';
...
export class RegisterUserUsecase implements IRegisterUserUsecase {
  ...
  async execute(data: RegisterUserRequestDto): Promise<string> {
    ...
    if (existingUsername) {
      throw new CustomError(HTTP_STATUS.CONFLICT, ERROR_MESSAGES.USERNAME_EXIST, 'username');
    }
